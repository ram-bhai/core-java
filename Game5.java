 ...
 */
 class Checkers extends JPanel {
    ...
    public Checkers() {
        ...
        setBackground(Color.orange);  // Dark green background.
        ...
        board.setBounds(0,0,186,347); // Note:  size MUST be 164-by-164 !
        newGameButton.setBounds(650, 60, 120, 30);
        resignButton.setBounds(650, 120, 120, 30);
        message.setBounds(0, 600, 350, 30);
    ...
    private class Board extends JPanel implements ActionListener, MouseListener {
         ...
         */
        void gameOver(java.lang.String string) {
            ...
            for (int row = 0; row < 17; row++) {
                for (int col = 0; col < 9; col++) {
                 if(row%2==0&&col%2==0)
                    ...
                    g.drawLine(90,10,170,10);
                    g.drawLine(45,50,90,50);
                    g.drawLine(90,50,130,50);
                    g.drawLine(10,90,50,90);
                    g.drawLine(50,90,90,90);
                    g.drawLine(90,90,130,90);
                    g.drawLine(130,90,170,90);
                    g.drawLine(10,130,50,130);
                    g.drawLine(50,130,90,130); 
                    g.drawLine(90,130,130,130);
                    g.drawLine(130,130,170,130);
                    // combine first baar
                    g.drawLine(10,10,50,50);
                    g.drawLine(50,50,90,90);
                    g.drawLine(170,10,130,50);
                    g.drawLine(10,10,50,50);
                    g.drawLine(130,50,90,90);
                    g.drawLine(90,10,90,50);
                    g.drawLine(90,50,90,90);
                    g.drawLine(10,90,10,130);
                    g.drawLine(170,90,170,130);
                    g.drawLine(50,90,50,130);
                    g.drawLine(90,90,90,130);
                    g.drawLine(10,90,50,130);
                    g.drawLine(90,90,130,130);
                   g.drawLine(130,90,130,130);
                   g.drawLine(90,90,50,130); 
                   g.drawLine(170,90,130,130);
                   g.drawLine(10,130,10,210);
                   g.drawLine(170,130,170,210);
                   g.drawLine(10,210,50,210);
                   g.drawLine(50,210,90,210);
                   g.drawLine(90,210,130,210);
                   g.drawLine(130,210,170,210);
                   g.drawLine(10,250,50,250);
                   g.drawLine(50,250,90,250);
                   g.drawLine(90,250,130,250);
                   g.drawLine(130,250,170,250);
                   g.drawLine(50,290,90,290);
                   g.drawLine(90,290,130,290);
                   g.drawLine(10,330,90,330);
                   g.drawLine(90,330,170,330);
                   
                   g.drawLine(10,210,10,250);
                   g.drawLine(50,210,50,250);
                   g.drawLine(90,210,90,250);
                   g.drawLine(130,210,130,250);
                   g.drawLine(170,210,170,250);
                   
                   g.drawLine(10,330,50,290);
                   g.drawLine(50,290,90,250);
                   g.drawLine(90,250,130,290);
                   g.drawLine(130,290,170,330);
                   
                   g.drawLine(90,330,90,290);
                   g.drawLine(90,290,90,250);
        
                   g.drawLine(90,250,50,210);
                   g.drawLine(50,210,10,170);
                   g.drawLine(10,170,50,130);
        
                   g.drawLine(90,250,130,210);
                   g.drawLine(130,210,170,170);
                   g.drawLine(170,170,130,130);
                   g.drawLine(130,130,90,90);
        
                   g.drawLine(10,170,170,170);
                   g.drawLine(90,130,90,210);
                   g.drawLine(50,130,90,170);
                   g.drawLine(130,130,90,170);
                   g.drawLine(90,170,50,210);
                   g.drawLine(90,170,130,210);
                   g.drawLine(50,130,50,210);
                   g.drawLine(130,130,130,210);
                   g.drawLine(50,210,10,250);
                   g.drawLine(130,210,170,250);
                }
            }  
            for (int row = 0; row < 17; row++) {
                for (int col = 0; col < 9; col++) {
                    ...
                    //     g.fillOval(4 + col*20, 4 + row*20, 15, 15);
                    //     g.setColor(Color.WHITE);
                    //     g.drawString("", 7 + col*20, 16 + row*20);
                    //     break;
    ...
    private static class CheckersData {
        ...
        void setUpGame() {
            for (int row = 0; row < 17; row++) {
                for (int col = 0; col < 9; col++) {
                        ...
                        if ((row ==0 &&( col == 0||col == 4 ||col ==8)) || (row==2 && (col==2||col==4||col==6))||(row==4 && (col==0||col==2||col==4||col==6||col==8)))
                          board[row][col] = BLACK;
                        else if((row==6 &&(col==0||col==2||col==4||col==6||col==8)))
                        	   board[row][col] = BLACK;
                        else if ((row ==10 && (col==0||col==2||col==4||col==6||col==8))||(row==12 && (col==0||col==2||col==4||col==6||col==8))||(row == 14 && (col==2||col==4||col==6))||(row == 16 && (col==0||col==4||col==8)))
                            board[row][col] = RED;
                        else
                            board[row][col] = EMPTY;
                }
        ...
        void makeMove(int fromRow, int fromCol, int toRow, int toCol) {
            ...
            if (fromRow - toRow == 4 || fromRow - toRow == -4) {
        ...
        CheckersMove[] getLegalMoves(int player) {
            ...
            for (int row = 0; row < 17; row++) {
                for (int col = 0; col < 9; col++) {
                    if (board[row][col] == player || board[row][col] == playerKing) {
                        if (canJump(player, row, col, row+2, col+2, row+4, col+4))
            ...
            if (moves.size() == 0) {
                for (int row = 0; row < 17; row++) {
                    for (int col = 0; col < 9; col++) {
                        if (board[row][col] == player || board[row][col] == playerKing) {
                            if (canMove(player,row,col,row+2,col+2))
        ...
        private boolean canMove(int player, int r1, int c1, int r2, int c2) {
             if ((r1==10&&c1==4)&&(r2==8&&c2==6)) {
                 return false;
                
             }
             if ((r1==0&&c1==0)&&(r2==2&&c2==0)) {
                return false;
               
            }
             if ((r1==10&&c1==4)&&(r2==8&&c2==2)) {
                return false;
               
            }
            if (r2 < 0 || r2 >= 16 || c2 < 0 || c2 >= 8)
