 ...
 class Checkers extends JPanel {
    ...
    private static class CheckersMove {
        ...
        boolean isJump() {
            ...
            return (fromRow - toRow == 4 || fromRow - toRow == -4);
        }
            ...
            for (int row = 0; row < 34; row++) {
                for (int col = 0; col < 18; col++) {
                 ...
                 //   g.drawLine(10,10,50,50);
                  ...
                  // g.drawLine(50,90,90,130);
                  // g.drawLine(90,90,130,130);
                //   g.drawLine(130,90,170,130);
                   g.drawLine(90,90,130,130);
                   g.drawLine(130,90,130,130);
                  // g.drawLine(50,90,10,130);
                   g.drawLine(90,90,50,130); 
                  // g.drawLine(130,90,90,130); 
